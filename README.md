...
|-----------|-----------|-----------|-----------|
| TB1 | 07/04/2025 | - Bryan Felix Martinez Ramos <br> - Merly Salon Puerta <br> - Gabriel Ferran Espinar Martínez  <br> - Angel Guillermo Berrospi Marin <br> - Orellana Rodriguez Mel Andree | Se han incluido los siguientes capítulos: <br> - Capítulo I: Introducción <br> - Capítulo II: Requirements Elicitation & Analysis <br> - Capítulo III: Requirements Specification <br> - Capítulo IV: Product Design <br> - Avance del Capítulo V: Product Implementation, Validation & Deployment hasta el punto 5.2.1.8 <br> - Avance de Conclusiones, Bibliografía y Anexos 
...
Nuestros segmentos de enfoque se dirigen a los siguientes grupos:

Compañías de transporte de carga: Pequeñas y medianas empresas que desean modernizar su gestión para mantenerse competitivas frente a grandes operadores, optimizar su control interno y brindar mayor trazabilidad a sus clientes.

Choferes de unidades de carga: Personal de campo responsable de registrar datos logísticos (kilometraje, consumo de combustible, entregas), interactuar con la aplicación y aportar evidencia de las operaciones realizadas.
